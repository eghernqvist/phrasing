...
describe Phrack::Serializer do

  let(:english_phrases) do
    PhrackPhrase.where(locale: :en)
  end

  let(:french_phrases) do
    PhrackPhrase.where(locale: :fr)
  end
  ...
  describe 'flatten_the_hash' do
    ...
    it 'with simple data' do
      ...
      new_hash = Phrack::Serializer.flatten_the_hash(hash)
  ...
  context 'import_yaml' do
    ...
    it 'simply formatted phrases' do
      yaml = <<-YAML
        en:
          ...
          outro: "Kthnx Bye"
      YAML
      Phrack::Serializer.import_yaml(StringIO.new(yaml))
    ...
    it 'overrides old values' do
      FactoryGirl.create(:phrack_phrase, key: "site.intro", value: "Go Home")
      FactoryGirl.create(:phrack_phrase, key: "site.outro", value: "Kthnx Bye")
      ...
      yaml = <<-YAML
        en:
          site:
            intro: "Hello World"
      YAML
      number_of_changes = Phrack::Serializer.import_yaml(StringIO.new(yaml))
  ...
  context 'imports and exports' do
    it 'without changing, should return 0 number of changes' do
      ...
      yaml = Phrack::Serializer.export_yaml
  ...
  context 'export_yaml' do
    ...
    it 'with different locales' do
      FactoryGirl.create(:phrack_phrase, key: "site.intro", value: "Hello", locale: :en)
      FactoryGirl.create(:phrack_phrase, key: "site.intro", value: "Bonjour", locale: :fr)
